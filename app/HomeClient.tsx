...
/** Sunucuda (page.tsx) hazırlanan bölümler; akış içinde yerlerine yerleştirilir. */
export interface HomeSlots {
  afterMarquee?: React.ReactNode;
  afterExperiences?: React.ReactNode;
  beforeTestimonials?: React.ReactNode;
  beforeFaq?: React.ReactNode;
}

export default function HomeClient({ slots = {} }: { slots?: HomeSlots }) {

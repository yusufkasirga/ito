...
export default function Home() {
  ...
  const faqItems = [
    { q: 'Как вы берёте оплату — и почему консультация платная?', a: 'Мы берём фиксированную плату за планирование — её оплачиваете вы. Мы не получаем комиссий от отелей, клиник или гидов, поэтому ни один поставщик не может заплатить нам за рекомендацию. В стоимость входит письменный персональный план в течение 72 часов; если вы путешествуете с нами, плата засчитывается в стоимость поездки, а если консультация не принесла вам пользы — мы её возвращаем.' },
    ...
    <main style={{ background: dm ? '#0a0f1a' : '#fffaf1', color: dm ? '#f0ede8' : '#071726', fontFamily: "var(--font-inter), system-ui, sans-serif", minHeight: '100vh', transition: 'background 0.3s, color 0.3s' }}>
      ...
      <header className="nav">
        <div className="nav-inner">
          <Link className="brand" href="/"><Image src="/logo.png" alt="Itinerary of Türkiye" width={96} height={96} /></Link>
      ...
      <section className="hero" id="top">
        <HeroVideo
            ...
            chapters={[
              { at: 0, label: 'Султанахмет · Стамбул' },
              { at: 4.1, label: 'Галата · Стамбул' },
              { at: 7.8, label: 'Каппадокия на рассвете' },
              { at: 11.5, label: 'Каппадокия' },
              { at: 15.2, label: 'Золотой Рог · Стамбул' },
              { at: 18.9, label: 'Босфор ночью' },
            ]}
          />
      ...
      <section className="section" id="about" style={{background: dm ? '#111827' : '#edf5f6'}}>
        <div className="container about-grid">
          ...
          <div className="about-img">
            <Image src="/images/pexels-3889742-800x1000.jpg" alt="Hot air balloons over Cappadocia at sunset, Türkiye" fill sizes="(max-width: 1100px) 100vw, 50vw" />
          </div>
        </div>
      </section>

  ...
  const features = [
    {
      ...
      desc: 'Kuratierte Urlaube und Reiseerlebnisse in der ganzen Türkei',
    },
    {
      icon: '🏥',
      title: 'Medizin & Ästhetik',
      desc: 'Beratung und Koordination für chirurgische und nicht-chirurgische Behandlungen',
    },
    {
      icon: '💼',
      title: 'Geschäftsreisen',
      desc: 'Umfassende Unterstützung für Geschäftsbesuche und Delegationen',
    },
    {
      icon: '🌐',
      title: 'Mehrsprachiges Team',
      desc: 'Experten, die viele Sprachen sprechen — auch Deutsch',
    },
  ];
    ...
    <main style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#fffaf1', minHeight: '100vh' }}>
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <h1>Ihr vertrauensvoller Begleiter<br /><span>in der Türkei.</span></h1>
          <p>
            Itinerary of Türkiye wurde mit einem einzigen Ziel gegründet: dafür zu sorgen, dass jeder Besucher dieses bemerkenswerten Landes genau das findet, was er sucht.
          </p>
        </div>
      </section>
      ...
      <section className="content">
        <div className="two-col">
          <div className="section-text">
            <p>
              Ob Urlaubsreise, medizinische oder ästhetische Behandlung oder Geschäftsreise — vom Moment Ihrer Ankunft an sind wir Ihr engagierter Partner vor Ort.
            </p>
            <p>
            ...
            <p>
              Unser Team vereint Spezialisten für Tourismus, medizinische Koordination und Business-Unterstützung — mehrsprachig und mit tiefer lokaler Expertise. Mit echtem Engagement für Ihre Zufriedenheit begleiten wir Sie bei jedem Schritt.
            </p>
          </div>
          <div className="about-image">
            <img
              src="/images/pexels-3889742-800x1000.jpg"
              alt="Heißluftballons über Kappadokien, Türkei"
            />
          </div>
        </div>
      </section>
      ...
      <section className="features-section">
        <div className="features-inner">
          <div className="eyebrow" style={{color: 'var(--gold)'}}>Was wir bieten</div>
          <h2 className="features-title">Alles, was Sie brauchen —<br />an einem Ort.</h2>
